Public Class frmAries
    Private Sub frmAries_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    End Sub
    Private Sub btnAries_Click(sender As Object, e As EventArgs) Handles btnAquarius.Click
        Me.Hide()
        frmAquarius.Show()
    End Sub

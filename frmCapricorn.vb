Public Class frmCapricorn
    Private Sub frmCapricorn_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    End Sub
    Private Sub btnAquarius_Click(sender As Object, e As EventArgs) Handles btnAquarius.Click
        Me.Hide()
        frmAquarius.Show()
    End Sub
